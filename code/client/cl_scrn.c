...
void SCR_RevertTo640(float* x, float* y, float* w, float* h) 
{
...
void SCR_DrawSmallCharToOverlay( int x, int y, int ch ) {
	int row, col;
	float frow, fcol;
	float size;
